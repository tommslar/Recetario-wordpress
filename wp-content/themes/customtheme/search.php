<?php
/**
 * The template for displaying all single posts of a custom category
 *
		...
		<?php if ( have_posts() ) : ?>
			<header class="page-header">
				<h4 class="page-title">
					...
					printf( esc_html__( 'Resultados para: %s', 'shurre' ), '<span>' . get_search_query() . '</span>' );
					?>
				</h4>
			</header><!-- .page-header -->
...
// JS para quedarme con los primeros 150 caracteres de la descripción
	...
	document.getElementsByClassName("descripcion-teaser")[3].innerHTML = document.getElementsByClassName("descripcion-teaser")[2].innerHTML.substring(0, 150);
</script>
