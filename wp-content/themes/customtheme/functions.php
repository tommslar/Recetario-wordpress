...
function shurre_scripts() {
	...
	/**
	 * Agregando libreria materializecss a través de CDN.
	 */
	wp_register_style( 'material_style', 'https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css' );
	wp_enqueue_style('material_style');
	wp_register_script( 'material_script', 'https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/js/materialize.min.js', null, null, true );
	wp_enqueue_script('material_script');
}
